...
public class ModdedBiomeProvider extends BiomeProvider
{
	...
	public ModdedBiomeProvider() 
	{
		this.biomeCache = new BiomeCache(this);
	}

	public ModdedBiomeProvider(long seed) 
	{
		this();
		GenLayer[] agenlayer = GenLayerFixFantasia.createWorld(seed);
		this.genBiomes = agenlayer[0];
		this.biomeIndexLayer = agenlayer[1];
	}

	public ModdedBiomeProvider(World world) 
	{
		this(world.getSeed());
	}
