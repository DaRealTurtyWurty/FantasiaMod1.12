...
public class CherryDoubleChestHandler extends WeakReference<TileEntityCherryChest> implements IItemHandlerModifiable
{
    // Dummy cache value to signify that we have checked and definitely found no adjacent chests
    public static final CherryDoubleChestHandler NO_ADJACENT_CHESTS_INSTANCE = new CherryDoubleChestHandler(null, null, false);
    private final boolean mainChestIsUpper;
    private final TileEntityCherryChest mainChest;
    private final int hashCode;

    public CherryDoubleChestHandler(@Nullable TileEntityCherryChest mainChest, @Nullable TileEntityCherryChest other, boolean mainChestIsUpper)
    {
        super(other);
    ...
    @Nullable
    public static CherryDoubleChestHandler get(TileEntityCherryChest chest)
    {
        ...
        for (int i = horizontals.length - 1; i >= 0; i--)   // Use reverse order so we can return early
        {
            ...
            if (block == blockType)
            {
                ...
                if (otherTE instanceof TileEntityCherryChest)
                {
                    TileEntityCherryChest otherChest = (TileEntityCherryChest) otherTE;
                    return new CherryDoubleChestHandler(chest, otherChest,
    ...
    @Nullable
    public TileEntityCherryChest getChest(boolean accessingUpper)
    {
    ...
    @Nullable
    private TileEntityCherryChest getOtherChest()
    {
        TileEntityCherryChest TileEntityCherryChest = get();
        return TileEntityCherryChest != null && !TileEntityCherryChest.isInvalid() ? TileEntityCherryChest : null;
    }
    ...
    public ItemStack getStackInSlot(int slot)
    {
        ...
        TileEntityCherryChest chest = getChest(accessingUpperChest);
    ...
    public boolean equals(Object o)
    {
        ...
        CherryDoubleChestHandler that = (CherryDoubleChestHandler) o;

        if (hashCode != that.hashCode)
            return false;

        final TileEntityCherryChest otherChest = getOtherChest();
    ...
    public boolean needsRefresh()
    {
        if (this == NO_ADJACENT_CHESTS_INSTANCE)
            return false;
        TileEntityCherryChest TileEntityCherryChest = get();
        return TileEntityCherryChest == null || TileEntityCherryChest.isInvalid();
    }
}