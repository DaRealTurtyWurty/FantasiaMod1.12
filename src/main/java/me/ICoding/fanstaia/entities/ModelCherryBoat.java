...
public class ModelCherryBoat extends ModelBase implements IMultipassModel
{
    ...
    public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
    {
        ...
        EntityCherryBoat entityboat = (EntityCherryBoat)entityIn;
    ...
    protected void renderPaddle(EntityCherryBoat boat, int paddle, float scale, float limbSwing)
    {
