...
public class ModelVlumBoat extends ModelBase implements IMultipassModel
{
    ...
    public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
    {
        ...
        EntityVlumBoat entityboat = (EntityVlumBoat)entityIn;
    ...
    protected void renderPaddle(EntityVlumBoat boat, int paddle, float scale, float limbSwing)
    {
