...
public class InventoryLargeCherryChest implements ILockableContainer
{
	/** Name of the chest. */
    ...
    public InventoryLargeCherryChest(String nameIn, ILockableContainer upperChestIn, ILockableContainer lowerChestIn)
    {
        this.name = nameIn;
