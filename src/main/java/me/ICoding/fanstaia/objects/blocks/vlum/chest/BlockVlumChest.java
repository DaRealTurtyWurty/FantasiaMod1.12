...
public class BlockVlumChest extends BlockContainer
{
    ...
    /** 0 : Normal chest**/
    public final BlockVlumChest.Type chestType;

    public BlockVlumChest(String name, BlockVlumChest.Type chestTypeIn)
    {
    	super(Material.WOOD);
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        ...
        if (stack.hasDisplayName())
        {
            ...
            {
                ((TileEntityVlumChest)tileentity).setCustomName(stack.getDisplayName());
            }
        }
    }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            if (ilockablecontainer != null)
            {
                ...
                if (this.chestType == BlockVlumChest.Type.BASIC)
                {
    ...
    public ILockableContainer getContainer(World worldIn, BlockPos pos, boolean allowBlocking)
    {
        ...
        {
            ILockableContainer ilockablecontainer = (TileEntityVlumChest)tileentity;
            ...
            else
            {
                for (EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL)
                {
                    ...
                    if (block == this)
                    {
                        ...
                        if (tileentity1 instanceof TileEntityVlumChest)
                        {
                            if (enumfacing != EnumFacing.WEST && enumfacing != EnumFacing.NORTH)
                            {
                                ilockablecontainer = new InventoryLargeVlumChest("container.cherry_chest_double", ilockablecontainer, (TileEntityVlumChest)tileentity1);
                            }
                            else
                            {
                                ilockablecontainer = new InventoryLargeVlumChest("container.cherry_chest_double", (TileEntityVlumChest)tileentity1, ilockablecontainer);
                            }
                        }
                    }
                }
    ...
    {
        return new TileEntityVlumChest();
    }
    ...
    public int getWeakPower(IBlockState blockState, IBlockAccess blockAccess, BlockPos pos, EnumFacing side)
    {
        ...
        else
        {
            ...
            if (tileentity instanceof TileEntityVlumChest)
            {
                i = ((TileEntityVlumChest)tileentity).numPlayersUsing;
            }
