...
public class InventoryLargeVlumChest implements ILockableContainer
{
	/** Name of the chest. */
    ...
    public InventoryLargeVlumChest(String nameIn, ILockableContainer upperChestIn, ILockableContainer lowerChestIn)
    {
        this.name = nameIn;
