...
public class BlockVuzineChest extends BlockContainer
{
    ...
    /** 0 : Normal chest**/
    public final BlockVuzineChest.Type chestType;

    public BlockVuzineChest(String name, BlockVuzineChest.Type chestTypeIn)
    {
    	super(Material.WOOD);
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        ...
        if (stack.hasDisplayName())
        {
            ...
            {
                ((TileEntityVuzineChest)tileentity).setCustomName(stack.getDisplayName());
            }
        }
    }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            if (ilockablecontainer != null)
            {
                ...
                if (this.chestType == BlockVuzineChest.Type.BASIC)
                {
    ...
    public ILockableContainer getContainer(World worldIn, BlockPos pos, boolean allowBlocking)
    {
        ...
        {
            ILockableContainer ilockablecontainer = (TileEntityVuzineChest)tileentity;
            ...
            else
            {
                for (EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL)
                {
                    ...
                    if (block == this)
                    {
                        ...
                        if (tileentity1 instanceof TileEntityVuzineChest)
                        {
                            if (enumfacing != EnumFacing.WEST && enumfacing != EnumFacing.NORTH)
                            {
                                ilockablecontainer = new InventoryLargeVuzineChest("container.vuzine_chest_double", ilockablecontainer, (TileEntityVuzineChest)tileentity1);
                            }
                            else
                            {
                                ilockablecontainer = new InventoryLargeVuzineChest("container.vuzine_chest_double", (TileEntityVuzineChest)tileentity1, ilockablecontainer);
                            }
                        }
                    }
                }
    ...
    {
        return new TileEntityVuzineChest();
    }
    ...
    public int getWeakPower(IBlockState blockState, IBlockAccess blockAccess, BlockPos pos, EnumFacing side)
    {
        ...
        else
        {
            ...
            if (tileentity instanceof TileEntityVuzineChest)
            {
                i = ((TileEntityVuzineChest)tileentity).numPlayersUsing;
            }
