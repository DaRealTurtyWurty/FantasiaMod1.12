...
public class BlockVlumFenceGate extends BlockHorizontal
{
	...
	public BlockVlumFenceGate(String name) 
	{
    ...
    public boolean canBeConnectedTo(IBlockAccess world, BlockPos pos, EnumFacing facing)
    {
        ...
        if (state.getBlock() instanceof BlockVlumFenceGate &&
            state.getBlockFaceShape(world, pos, facing) == BlockFaceShape.MIDDLE_POLE)
        {
            Block connector = world.getBlockState(pos.offset(facing)).getBlock();
            return connector instanceof BlockVlumFence || connector instanceof BlockWall;
        }
        return false;
    }
