...
public class InventoryLargeVuzineChest implements ILockableContainer
{
	/** Name of the chest. */
    ...
    public InventoryLargeVuzineChest(String nameIn, ILockableContainer upperChestIn, ILockableContainer lowerChestIn)
    {
        this.name = nameIn;
